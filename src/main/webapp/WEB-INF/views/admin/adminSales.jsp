...
<script type="text/javascript">
	$(function(){
		$("#mainb1,#mainb2,#day2,#day3").hide();
		$("#listSize").change(function(){
			if($(this).val()==1){
				$("#mainb1, #mainb2,#day2,#day3").hide();
				$("#mainb,#day1").show();
			}else if($(this).val()==2){
				$("#mainb, #mainb2,#day1,#day3").hide();
				$("#mainb1,#day2").show();
			}else if($(this).val()==3){
				$("#mainb, #mainb1,#day1,#day2").hide();
				$("#mainb2,#day3").show();
			}
													...
													<tbody>
														...
														<c:forEach var="i" begin="1" end="10">
															<tr role="row" class="odd">
																...
																<td><a href="#">1</a></td>
																<td><fmt:formatNumber value="${i*1000 + 10000 }" pattern="0,000"/></td>
																<td><fmt:formatNumber value="${(i*1000 + 10000)-(i*1000 + 10000)/10}" pattern="0,000"/></td>
																<td><fmt:formatNumber value="${(i*1000 + 10000)/10 }" pattern="0,000"/></td>
															</tr>
													...
													<tbody>
														...
														<c:forEach var="i" begin="1" end="10">
															<tr role="row" class="odd">
																...
																<td><a href="#">${i+90 }</a></td>
																<td><fmt:formatNumber value="${i*100000 + 1000000 }" pattern="0,000"/></td>
																<td><fmt:formatNumber value="${(i*100000 + 1000000)-(i*100000 + 1000000)/10}" pattern="0,000"/></td>
																<td><fmt:formatNumber value="${(i*100000 + 1000000)/10 }" pattern="0,000"/></td>
															</tr>
													...
													<tbody>
														...
														<c:forEach var="i" begin="1" end="5">
															<tr role="row" class="odd">
																...
																<td><fmt:formatNumber value="${i*1000000 + 10000000 }" pattern="0,000"/></td>
																<td><fmt:formatNumber value="${(i*1000000 + 10000000)-(i*1000000 + 10000000)/10}" pattern="0,000"/></td>
																<td><fmt:formatNumber value="${(i*1000000 + 10000000)/10 }" pattern="0,000"/></td>
															</tr>
