...
<script type="text/javascript">
	$(function() {
		...
		$("#writer_search").click(
				function() {
					window.open("adminContents_WriterSearch.jsp", "",
								...
								<form method="get" class="form-horizontal insert_area_jm">
									...
									<div class="insert_layout book_info_insert_area_jm">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" placeholder="도서번호(ISBN)를 입력하세요" class="form-control">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" placeholder="도서명을 입력하세요" class="form-control">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" placeholder="저자를 입력하세요" class="form-control">
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-2 control-label">역자</label>
											<div class="col-sm-10">
												<input type="text" placeholder="역자를 입력하세요" class="form-control">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" placeholder="출판사를 입력하세요" class="form-control">
											</div>
										</div>
